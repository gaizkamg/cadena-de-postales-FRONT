<template>
  ...
  <div class="block">
    ...
    <p class="note">
      Importante que sea alumnado presente en el centro durante la dinámica.<br>
...
<style >
/* Contenedor general info-section */
.info-section {
  padding: 20px;
  margin: 20px auto;
  max-width: 700px;
...
/* PARTICIPANT BLOCK: Grid responsive */
.participant-block {
  display: grid;
...
/* Estilos de texto dentro del bloque participante */
